try {
  ...
  var options17 = {
    series: [{
      name: "Team",
      data: [58, 11, 50, 51, 94, 91, 98, 80, 14]
    }],
    chart: {
      height: 190,
      type: 'line',
  ...
  var options18 = {
    series: [{
      name: "Project",
      data: [100, 141, 135, 151, 149, 162, 69, 91, 148]
    }],
    chart: {
      height: 190,
      type: 'line',
  ...
  var options19 = {
    ...
    plotOptions: {
      radialBar: {
        hollow: {
          margin: 15,
          size: '70%',
          image: 'assets/img/profile-16-2.png',
          imageWidth: 120,
          imageHeight: 120,
          imageClipped: false
        },
    ...
    fill: {
      type: 'image',
      image: {
        src: ['assets/img/auth_1_bg_3.jpg'],
      }
    },
    stroke: {
      lineCap: 'round'
  ...
  /* Polar Chart - Render */
  var chart = new ApexCharts(
    document.querySelector("#polarChartOne"),
    options14
  );
  chart.render();


  /* Visitor Chart - Render */
  var chart = new ApexCharts(
  ...
  /* Client Overview - Render */
  var chart = new ApexCharts(
    document.querySelector("#clientOverview"),
    options16
  );
  chart.render();

  /* Team Overview - Render */
  var chart = new ApexCharts(
    document.querySelector("#teamOverview"),
    options17
  );
  chart.render();
  ...
  var chart = new ApexCharts(
    document.querySelector("#projectOverview"),
    options18
  );
  chart.render();

  /* Monthly Income - Render */
  var chart = new ApexCharts(
