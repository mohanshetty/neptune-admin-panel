try {
  ...
  var options14 = {
    ...
    colors: ['#f1c118', '#54ab31', '#e71b1b', '#0dcbfa', '#244b83'],
    labels: ['Dennys', 'Spotify', 'CNN', 'Twitter', 'Facebook'],
    legend: {
      show: false,
      position: 'bottom',
  ...
  $('#serverSwitch').click(function() {
    if($(this).is(':checked')) {
      $(this).closest('.switch-outer-container').addClass('active');
      $(this).closest('.switch-outer-container').find('.switch-toggle-text').html('On');
    } else {
      $(this).closest('.switch-outer-container').find('.switch-toggle-text').html('Off');
      $(this).closest('.switch-outer-container').removeClass('active');
    }
  });
  $('#refreshSwitch').click(function() {
    if($(this).is(':checked')) {
      $(this).closest('.switch-outer-container').addClass('active');
      $(this).closest('.switch-outer-container').find('.switch-toggle-text').html('On');
    } else {
  ...
  $('#doNotDisturbSwitch').click(function() {
    if($(this).is(':checked')) {
      $(this).closest('.switch-outer-container').addClass('active');
      $(this).closest('.switch-outer-container').find('.switch-toggle-text').html('On');
    } else {
  ...
  $('#secureModeSwitch').click(function() {
    if($(this).is(':checked')) {
      $(this).closest('.switch-outer-container').addClass('active');
      $(this).closest('.switch-outer-container').find('.switch-toggle-text').html('On');
    } else {
